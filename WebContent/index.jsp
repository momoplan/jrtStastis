	...
	<head>
		...
		<script type="text/JavaScript"> 
           ...
           function changepic(){
              ...
              document.getElementById('chkimg').src='getrandnum.do?num=' + num;   
           }
       </script>
	</head>
			...
			<table width="681" border="0" align="center" cellpadding="0"
				...
				<tr>
					<td width="353" height="259" align="center" valign="bottom"
						background="images/login_1_1.GIF">
					...
					<td width="212" background="images/login_2.jpg">
							...
							<tr>
								...
								<td width="147" colspan="2">
									<input name="username" id="username" type="text"
										style="background: url(images/login_6.gif) repeat-x; border: solid 1px #27B3FE; height: 20px; width: 130px; background-color: #FFFFFF;"
							...
							<tr>
								<td colspan="3" align="center">
									<input type="submit" id="btn_ok"
										style="background: url(images/login_5.gif) no-repeat; width: 69px;"
										value=" 登录 " />
					...
					<td width="116" background="images/login_3.gif">
						&nbsp;
					</td>
				</tr>
				<tr>
