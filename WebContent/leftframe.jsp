...
//window.top.frames['manFrame'].location = "manframe.jsp" 
}
document.write("<script src=js/nav.js></" + "script>");
</script>
<c:choose>
  <c:when test="${role.name == '推广合作方'}">
<body onload="initinav('推广合作')">
<div id="left_content">
     <div id="user_info">欢迎您，<strong>${user2.name}</strong><br />[<a href="#">${role.name}</a>，<a href="logout.jsp" target="_parent">退出</a>]</div>
	 <div id="main_nav">
