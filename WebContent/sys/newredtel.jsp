		...
		<script type="text/JavaScript">
           ...
           function save(){
              ...
              /*
                 ...
                 $("#error_tel").text("手机号格式错误！");
                 flag = false;
              */
              }else if(tel.length !=11){
                 $("#error_tel").text("手机号应为11位！");
                 flag = false;             
              }
				...
				<div class="table_db">
					<table width="98%" border="0" align="center" cellpadding="3"
						...
						<tr bgcolor="#ffffff">
							...
							<td>
								<input id="tel" name="tel" type="text" maxlength="11" value="${model.tel}"
								    style="float: left; width: 200px" />
								<div id="error_tel" style="color: #C04000; overflow: left;">${msg}</div>
							</td>
						</tr>						
						<tr bgcolor="#ffffff">
