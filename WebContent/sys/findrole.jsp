...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<form id="form1" method="post" action="updaterole.do">
				...
				<div class="table_db">
					<table width="98%" border="0" align="center" cellpadding="3"
						...
						<tr bgcolor="#ffffff">
							...
							<td>
								<input id="name" name="name" type="text" maxlength="6" value="${model.name}"
						...
						<tr bgcolor="#ffffff">
							...
							<div class="dtree">
								...
								<script type="text/javascript"> 
	                               ...
	                               d.add(${list.id}, ${list.fid}, 'PRESTR', '${list.id}', '${list.name}', ${list.bool});
	                               </c:forEach>
	                               document.write(d);
	                               d.closeAll();
                                </script>
