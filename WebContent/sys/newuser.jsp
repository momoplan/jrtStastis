...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<script type="text/JavaScript">
           ...
           function oninit(){
              $("#roleid").val('${model.roleid}'); //selectedValue = 2;              
           }
				...
				<div class="table_db">
					<table width="98%" border="0" align="center" cellpadding="3"
						...
						<tr bgcolor="#ffffff">
							...
							<td>
								<input id="name" name="name" type="text" maxlength="20" value="${model.name}"
									style="float: left; width: 200px" />
								<div id="error_name" style="color: #C04000; overflow: left;">${msg}</div>
							</td>
						</tr>
						<tr bgcolor="#ffffff">
							<td width="120px" class="left_title_1">
							...
							<td>
								<input id="pass" name="pass" type="password" maxlength="20" value=""
									style="float: left; width: 200px" />
						...
						<tr bgcolor="#ffffff">
							...
							<td>
								<input id="realname" name="realname" type="text" maxlength="20" value="${model.realname}"
									style="float: left; width: 200px" />
						...
						<tr bgcolor="#ffffff">
							...
							<td>
								<input id="tel" name="tel" type="text" maxlength="60" value="${model.tel}"
								    style="float: left; width: 200px" />
								<div id="error_tel" style="color: #C04000; overflow: left;"></div>
							</td>
						</tr>						
						<tr bgcolor="#ffffff">
							<td width="120px" class="left_title_2">
							...
							<td>
								<input id="bz" name="bz" type="text" maxlength="100" value="${model.bz}"
									style="float: left; width: 200px" />
								<div id="error_bz" style="color: #C04000; overflow: left;"></div>
							</td>
						</tr>
						<tr bgcolor="#ffffff">
							<td width="120px" class="left_title_2">
